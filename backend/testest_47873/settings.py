"""
Django settings for testest_47873 project.
...
ROOT_URLCONF = 'testest_47873.urls'
...
WSGI_APPLICATION = 'testest_47873.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "testest_47873 API",
    "DESCRIPTION": "API documentation for testest_47873 App",
    "VERSION": "v1",
}
